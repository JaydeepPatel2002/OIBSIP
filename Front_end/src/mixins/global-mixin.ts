...
const FOODORDER_API = BASE_API + '/foodorder'
const WORKHOURS_API = BASE_API + '/WorkedHours'
const EMPLOYEE_API = BASE_API + '/employee'
...
export class GlobalMixin extends Vue {
  ...
  FOODORDER_API = FOODORDER_API
  WORKHOURS_API = WORKHOURS_API
